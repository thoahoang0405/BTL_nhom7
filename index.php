        ...
        <nav class="navbar navbar-expand-lg navbar-dark header-row bg-black container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class=" nav-item d-flex">
                        ...
                        <input class="form-control me-2 btn-group" id="inputsearch" type="search" placeholder="Photos,people or groups" aria-label="Search">
                        </div>
                    </form>
            ...
            <div class="row">
                <div class="col-md-8 ">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="nav-item dropdown mt-3">
                                <a class="nav-link ms-3 dropdown-toggle all-act" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown"
                                    aria-expanded="false">
                                     All Activity
                                </a>
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><a class="dropdown-item " href="#"><h5>All Activity</h5></a></li>
                    ...
                    <div class="row">
                        ...
                        <p class="text-lg-center">Check out the recommended photographers below and start following people to see their content here.</p>
                    </div>
                        ...
                        <div class="row">
                            <div class="body">
                                ...
                                <div class="title-user mt-4">
                                    <a href="https://www.flickr.com/groups/52242404882@N01" class="name "> Flickr-at-Home
                                    </a>
                                </div>
